...
import { FileText, FileSpreadsheet, Download, Calendar, CheckCircle2, XCircle, Store, Layers } from 'lucide-react';
...
export const ReportsView: React.FC = () => {
  ...
  // Filter branches created up to or during selected month
